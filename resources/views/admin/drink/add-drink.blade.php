...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../../../../public/css/Admin/add-drink.css" />
        <link
            rel="stylesheet"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="cat_id" class="form-control">
                                                                <optgroup label="Cà Phê">
                                                                    <option value="option3-1">Cà Phê Việt Nam</option>
                                                                    <option value="option3-2">Cà Phê máy</option>
                                                                    <option value="option3-2">Cold Brew</option>
                                                                </optgroup>
                                                                <optgroup label="Trà">
                                                                    <option value="option4-1">Trà trái Cây</option>
                                                                    <option value="option4-2">Trà sữa Macchiato</option>
                                                                <optgroup label="Cloud">
                                                                    <option value="option4-1">CloudTea</option>
                                                                    <option value="option4-2">CloudeFee</option>
                                                                <optgroup label="Thức uống đá say">
                                                                    <option value="option4-1">Đá say Frosty</option>
                                                                <optgroup label="Bánh & Snack">
                                                                    <option value="option4-1">Bánh mặn</option>
                                                                    <option value="option4-2">Bánh ngọt</option>
                                                                    <option value="option4-2">Snack</option>
                                                            </select>
                                                        </div>
                                                        <br>
